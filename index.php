            ...
            <div class="deliver__wrapper">
                <div class="deliver__up">
                    <div class="deliver__up-left">
                        <h2 class="deliver__title">Доставляем металлопрокат <br> по <span>всей России
                                и в страны СНГ</span></h2>
                        <p class="deliver__subtitle">Отправляем сборными и прямыми <br> машинами <span>через 24 часа
                                после оплаты</span></p>
                    </div>
            ...
            <div class="footer__cols">
                <div class="footer__col footer__about">
                    ...
                    <div class="footer__about-address footer__address">
                        ...
                        <p class="footer__text footer__address-text">Санкт-Петербург, ул. Заозерная, дом 8, корпус 1,
                            офис 27</p>
                    </div>
                ...
                <div class="footer__mb-list__wrapper">
                    ...
                    <div class="header__mb-nav">
                        ...
                        <ul class="footer__col">
                            ...
                            <li class="header__mb-item">
                                <a class="footer__title footer__customers-link"
                                    href="../shipment-page.html">Отгрузки</a>
                            </li>
                            <li class="header__mb-item">
                                <a class="footer__title footer__customers-link" href="../reviews.html">Отзывы и
                                    сертификаты</a>
                            </li>
                        </ul>
                    </div>
