          ...
          <div class="footer__network">
            <a href="http://">
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="15" cy="15" r="14.5" stroke="#808080"></circle>
            ...
            <a href="http://">
              <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M19.2921 10.8233C19.2921 11.2954 18.9093 11.6783 18.437 11.6783C17.9649 11.6783 17.582 11.2954 17.582 10.8233C17.582 10.351 17.9649 9.96826 18.437 9.96826C18.9093 9.96826 19.2921 10.351 19.2921 10.8233Z" fill="#808080"></path>
              </svg>
            </a>
          </div>
        </div>
          ...
          <div class="footer__serach">
            <div class="header__main-search header__main-search__mb">
              <svg width="19" height="19" viewBox="0 0 19 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.4855 14.6L18 18M16.8667 8.93333C16.8667 13.3148 13.3148 16.8667 8.93333 16.8667C4.55187 16.8667 1 13.3148 1 8.93333C1 4.55187 4.55187 1 8.93333 1C13.3148 1 16.8667 4.55187 16.8667 8.93333Z" stroke="#9D9D9C" stroke-width="2" stroke-linecap="round"></path>
              </svg>
        ...
        <div class="header__mb-social">
          <a href="">
            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="22.5" cy="22.5" r="22" stroke="#808080"></circle>
          ...
          <a href="">
            <svg width="45" height="45" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M28.9382 16.2347C28.9382 16.9429 28.364 17.5172 27.6556 17.5172C26.9473 17.5172 26.373 16.9429 26.373 16.2347C26.373 15.5262 26.9473 14.9521 27.6556 14.9521C28.364 14.9521 28.9382 15.5262 28.9382 16.2347Z" fill="#808080"></path>
            </svg>
          </a>
        </div>
      </div>
        ...
        <div class="popup__content">
            ...
            <div class="popup__body">
                <h2 class="popup__body-title">Получите расчет <br>
                    <span class="orange__text">актуальных цен</span> на поставку
                </h2>
                ...
                <form action="" class="popup__form">
                    ...
                    <label for="" class="popup__form-explain">
                        <textarea class="popup__form-explain-input" placeholder="Опишите, что нужно и в каком объеме"
                            name="" id=""></textarea>
                    </label>
        ...
        <div class="popup__content">
            ...
            <div class="popup__body">
                <h2 class="popup__body-title">Перезвоним
                    <span class="orange__text">в удобное время</span>
                </h2>
                <h3 class="popup__body-subtitle">Заполните форму, мы перезвоним в рабочее время и ответим на все вопросы
                </h3>
                <form action="" class="popup__form">
                    <label for="" class="popup__form-label">
                        Введите номер телефона
        ...
        <div class="filter__popup-content filter__popup__container">
            ...
            <button class="btn filter__popup-btn">
                ...
                <svg width="17" height="15" viewBox="0 0 17 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9.66667 1.5L15.5 7.5M15.5 7.5L9.66667 13.5M15.5 7.5L1.5 7.5" stroke="white"
                        stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
            </button>
        </div>
